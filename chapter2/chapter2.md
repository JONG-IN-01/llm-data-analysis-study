...
```text
https://github.com/JONG-IN-01/llm-data-analysis-study/blob/main/chapter2/chapter2.md
```
...
환경 파일과 비밀정보를 분리해야 하는 이유는 프로젝트 실행에 필요한 정보는 공유하면서 민감정보는 외부에 노출하지 않기 위해서이다.
